...
function user_setup()
    state.OffenseMode:options('Normal', 'Acc', 'DD', 'DD2', 'Triple', 'Counter')--'Old', 'SomeAcc', 'Special', 'Hizamaru', 'Test', 'STP'
    state.WeaponskillMode:options('Normal', 'Mod', 'Mod2')--'SomeAcc', 'Acc', 'Fodder', 'Mod', 'Mod2', 'Mod3', 'Mod4'
	state.HybridMode:options('Normal', 'Counter')--'PDT', 'EVASION',
    state.PhysicalDefenseMode:options('PDT', 'Counter')--'HP', 'EVASION', 'Guard'
